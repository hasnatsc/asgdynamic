...
class ProcessingWorkOrderServiceTest {
    ...
    void setUp() {
        ...
        when(numbering.next(eq(DocumentType.PROCESSING_WORK_ORDER), any(LocalDate.class), any())).thenReturn("PWO-2026-000001");
        ...
        service = new ProcessingWorkOrderService(repository, numbering, parentDraw, DocumentRefs.references(UNIT), context);
