...
public class FabricsDeliveryController {
    ...
    private static Map<String, Object> toRow(BusinessDocument d) {
        ...
        row.put("deliveryOrderId", idOf(d.getParentDocument()));
    ...
    private static Map<String, Object> toDetail(BusinessDocument d) {
        ...
        detail.put("lineGroups", d.getLineGroups().stream().map(FabricsDeliveryController::toGroup).toList());
        return detail;
    }
    ...
    private static Map<String, Object> toGroup(BusinessDocumentLineGroup g) {
        ...
        row.put("colorLines", g.getColorLines().stream().map(FabricsDeliveryController::toColorLine).toList());
        return row;
    }
    ...
    private static Map<String, Object> toSourceOption(BusinessDocumentColorLine deliveryOrderColorLine) {
        Map<String, Object> row = new LinkedHashMap<>();
        row.put("sourceColorLineId", deliveryOrderColorLine.getId());
        row.put("construction", deliveryOrderColorLine.getLineGroup().getFabric().getConstruction());
        row.put("colorName", deliveryOrderColorLine.getColorName());
        row.put("orderedQuantity", deliveryOrderColorLine.getQuantity());
        row.put("outstandingQuantity", deliveryOrderColorLine.outstandingQuantity());
        return row;
    }
}
